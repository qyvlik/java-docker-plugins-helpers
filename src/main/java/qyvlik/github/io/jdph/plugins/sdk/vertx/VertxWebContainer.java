package qyvlik.github.io.jdph.plugins.sdk.vertx;

import qyvlik.github.io.jdph.go.error;
import qyvlik.github.io.jdph.plugins.sdk.IServerContext;
import qyvlik.github.io.jdph.plugins.sdk.IServerHandler;
import qyvlik.github.io.jdph.plugins.sdk.IWebContainer;
import qyvlik.github.io.jdph.plugins.volume.resp.ErrorResponse;
    ...
    private IServerContext warp(RoutingContext ctx) {
        return new IServerContext() {
            ...
            public <REQ> REQ read(Class<REQ> requestClazz) {
                var body = ctx.body();
                var b = body.asPojo(requestClazz);
                return b;
            }
